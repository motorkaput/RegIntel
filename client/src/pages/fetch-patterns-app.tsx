...
export default function FetchPatternsApp() {
  ...
  return (
    <div className="min-h-screen bg-surface-white">
      ...
      <div className="bg-blue-50 border-b border-blue-200 py-3 sticky z-30" style={{top: '65px'}}>
      ...
      <main className="pt-0 pb-6">
        ...
        <div className="bg-gray-50 border-b border-gray-200 py-3 sticky z-20" style={{top: '128px'}}>
